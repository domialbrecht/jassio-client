  ...
  <div class="relative mt-48">
    <div class="container mx-auto mb-40 text-center">
      ...
      <div class="mt-24 grid grid-cols-4 gap-10 grid-flow-row">
        <a
          class="px-8 py-3 text-2xl text-white tracking-widest bg-dark hover:bg-default uppercase"
        ...
        >Wie Wisä</a>
        <a
          class="px-8 py-3 text-2xl flex justify-center text-white tracking-widest bg-dark hover:bg-default uppercase"
          href="discrod"
          target="_blank"
        >
